...
> 原文:[https://moralis . io/NFT-metadata-storage-how-to-store-NFT-metadata/](https://moralis.io/nft-metadata-storage-how-to-store-nft-metadata/)
...
![](../Images/83227703e8f2523567a534efe72dfffb.png)
...
![](../Images/052c18a4f7649150a3c0f4ca18290b4d.png)
...
![](../Images/8668f8bc1d393226366503ea06776d7b.png)
...
![](../Images/45f5cc668ca15708e232fd9c0bbd433a.png)
...
![](../Images/352368bad907540692e0c3fb886097a4.png)

### 初始设置第 1 部分–激活您的 Firebase 存储桶

从访问 Firebase 控制台开始。在那里，您可以使用现有项目或添加新项目:

![](../Images/de82a45e89461d66abb353716ac0d278.png)

进入 Firebase 项目仪表板后，展开“构建”菜单，然后单击“存储”选项:

![](../Images/a7525d7304a187fd2a0218444f54b81f.png)

加载“存储”页面后，单击“开始”按钮:

![](../Images/c003e1f6f46fc397b2cb3f7daaf57b32.png)

点击上面的按钮后，你就可以设置 Firebase 的云存储了。由于这是一个示例项目，我们建议选择测试模式。然后，点击“下一步”继续:

![](../Images/d86d3a903a2f4e7380b8d2b11edc03ef.png)

最后，点击“完成”按钮完成设置:

![](../Images/2bd6bdc84ee0831d7f2b44ff1effbbc6.png)

因此，您应该会看到项目的“存储”页面:

![](../Images/2cbcca06b03be89b3e8305e070fe458e.png)

接下来，您需要创建新的私钥。为此，您需要通过单击侧面菜单中的齿轮图标来访问“项目设置”页面:

![](../Images/e6bee1ca54b04915c4100e3b80dcc552.png)

接下来，选择“服务帐户”选项卡:

![](../Images/e7cdc2b44ba255d016a44f301e0f2617.png)

然后，向下滚动并确保“Node.js”被选中:

![](../Images/c8e2220ca284df081ad04704f45b5b84.png)

最后，单击“生成新的私钥”按钮，然后在弹出窗口中进行确认(单击“生成密钥”):

![](../Images/2e501fde5ab84f12a9573085c3d42f16.png)
...
![](../Images/ba42339eb11e5f2b6c949f67b097b496.png)
...
![](../Images/659e86576fe12216d90e0f798c6a152e.png)
...
![](../Images/bee2ee114b6f186aac1f175ab47ce3f7.png)

最后，您还需要添加从 Firebase 下载的 JSON 文件(之前您单击“Generate key”按钮时下载的)。您只需从浏览器中拖放即可:

![](../Images/b9e8cdf2665ad65bf7292709dee16ef8.png)
...
![](../Images/ae8f535878232b34a2f12c1826daf021.png)
...
(async () => {
    for (let i = 1; i < 11; i++) {
    await uploadFile(`./images/${i}.png`, `${i}.png`);
...
![](../Images/e8d3ee26bcbd4ce59766193b2d43d7f1.png)
...
![](../Images/861a3503bd14d4404432651690585c27.png)

此外，你的 Firebase 的“存储”页面应该反映你的进展:

![](../Images/dbc5b76d5a3ccef1ea67ad140eeda235.png)
...
![](../Images/7781b672cd57f621c5114417c720b977.png)
...
![](../Images/2cebf299c48975c47bc2546e5b65cbb4.png)
